...
Jarvis 支持 [Model Context Protocol (MCP)](https://modelcontextprotocol.io/) 服务器。只需告诉 Jarvis 你想配置的 MCP 服务器即可，例如：

```
帮我配置一个 MCP Server: npx -y @modelcontextprotocol/server-filesystem
```
